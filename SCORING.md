...
|---|-----------|----------|-------|-------|
| A-1 | Test suite | 5,658 tests across 19 packages, 0 failures | Measured | 10 |
| A-2 | Type safety | 38/38 packages typecheck clean (tsc --noEmit) | Measured | 10 |
| A-3 | Build | 21/21 packages build green (tsup via turbo) | Measured | 10 |
