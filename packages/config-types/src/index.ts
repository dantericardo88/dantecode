...
export interface DurableExecutionPolicyEvidence {
  filesCreated: string[];
...
export interface DurableExecutionPolicyPhaseStatus {
  name: string;
  status: "pending" | "active" | "complete" | "failed";
  evidence?: DurableExecutionPolicyEvidence;
  verifiedAt?: number;
  error?: string;
}

export interface DurableExecutionPolicyRetryEntry {
  tool: string;
  args: string;
  error?: string;
  timestamp: number;
...
export interface DurableExecutionPolicyState {
  retryHistory?: DurableExecutionPolicyRetryEntry[];
  phases?: DurableExecutionPolicyPhaseStatus[];
}
...
export interface DurableRun {
  ...
  executionPolicyState?: DurableExecutionPolicyState;
