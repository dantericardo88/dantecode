...
const RESULTS: SearchResult[] = [
  {
    ...
    snippet:
      "Learn how to optimize React components for better rendering performance with useMemo, useCallback, and React.memo.",
    source: "tavily",
    rank: 1,
  },
  {
  ...
  },
  {
    ...
    snippet:
      "React hooks API reference including useState, useEffect, useMemo, useCallback, useRef, and more.",
    source: "exa",
    rank: 3,
  ...
  },
  {
    ...
    snippet:
      "When should you use React.memo? Detailed answers with code examples for optimizing component re-renders.",
    source: "brave",
    rank: 4,
...
describe("rerankResults", () => {
  ...
  it("boosts results matching task context", () => {
    const reranked = rerankResults(RESULTS, {
      query: "hooks",
      taskDescription:
        "I am building a React app and need to optimize rendering with memoization hooks",
    });
