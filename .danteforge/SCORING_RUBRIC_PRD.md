...
Start with the canonical 50-dimension DanteCode product matrix. Dimensions 1-28
are the original capability matrix; dimensions 29-36 are product-frontier
dimensions covering evals, trust, governance, collaboration, decomposition,
regression prevention, onboarding, and portability. Dimensions 37-50 are
frontier-operating dimensions covering adaptation, latency, observability,
configuration, offline behavior, privacy, docs, extensibility, benchmark
transparency, scale, language breadth, accessibility, deployment intelligence,
and learning loops.

### Supported use cases

- Score one repo against a 50-dimension matrix.
...
- `enterprise`
- `eval_infrastructure`
- `ux_trust_explainability`
- `context_governance`
- `human_agent_collaboration`
- `task_decomposition`
- `regression_prevention`
- `onboarding_time_to_value`
- `ecosystem_portability`
- `model_quality_adaptation`
- `latency_responsiveness`
- `observability_telemetry`
- `configuration_ergonomics`
- `offline_degraded_mode`
- `data_privacy_controls`
- `documentation_quality`
- `extensibility_developer_experience`
- `benchmark_transparency`
- `multi_repo_monorepo_scale`
- `language_framework_breadth`
- `accessibility_inclusive_ux`
- `deployment_environment_intelligence`
- `learning_loop_self_improvement`
...
- `packages/danteforge/src/scoring/dimensions.ts`
...
- `packages/danteforge/src/scoring/evidence.ts`
...
- `packages/danteforge/src/scoring/rubrics.ts`
- `packages/danteforge/src/scoring/score-dimension.ts`
...
- `packages/danteforge/src/scoring/run-matrix.ts`
...
- `packages/danteforge/src/scoring/report.ts`
...
1. DanteForge can score one subject against the canonical 50-dimension matrix.
